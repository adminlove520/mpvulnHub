> **原文链接**: https://mp.weixin.qq.com/s?__biz=MzkwOTE5MDY5NA==&mid=2247506828&idx=1&sn=4dcc2055faf8a5122af10eb038e0e5ab
...
头提示服务器在验证 JWT 签名时应使用哪个密钥。在安全设置中，此值应与受信任密钥标识符的静态列表进行匹配。  
